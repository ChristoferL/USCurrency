...
minetest.register_node("uscurrency:shop", {
	description = "Shop",
	paramtype2 = "facedir",
	tiles = {"shop_top.png",
	                "shop_top.png",
	...
	on_rightclick = function(pos, node, clicker, itemstack)
		...
		if clicker:get_player_name() == meta:get_string("owner") and not clicker:get_player_control().aux1 then
			minetest.show_formspec(clicker:get_player_name(),"uscurrency:shop_formspec",default.shop.formspec.owner(pos))
		else
			minetest.show_formspec(clicker:get_player_name(),"uscurrency:shop_formspec",default.shop.formspec.customer(pos))
		end
	end,
...
minetest.register_on_player_receive_fields(function(sender, formname, fields)
	if formname == "uscurrency:shop_formspec" and fields.exchange ~= nil and fields.exchange ~= "" then
